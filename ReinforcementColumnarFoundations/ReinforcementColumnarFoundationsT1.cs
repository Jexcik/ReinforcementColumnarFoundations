...
namespace ReinforcementColumnarFoundations
{
    public class ReinforcementColumnarFoundationsT1 /*: IExternalCommand*/
    {
        ...
        //public Result Execute(UIApplication uiapp, Document doc, List<FamilyInstance> foundationList, ReinforcementColumnarFoundationsViewModel reinforcementColumnarFoundationsWPF)
        //{
        //    View view = doc.ActiveView;

        //    RebarBarType firstMainBarType = reinforcementColumnarFoundationsWPF.SelectedFirstRebarType;
